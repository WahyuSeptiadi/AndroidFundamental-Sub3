package com.kevin.git.view.follower;
...
import com.kevin.git.helper.CustomOnItemClickListener;
import com.squareup.picasso.Picasso;
import com.kevin.git.data.local.MappingHelper;
...
import com.kevin.git.view.detail.DetailActivity;
...
import static com.kevin.git.data.local.DatabaseContract.FavColumns.AVATAR;
import static com.kevin.git.data.local.DatabaseContract.FavColumns.CONTENT_URI;
import static com.kevin.git.data.local.DatabaseContract.FavColumns.IDUSER;
import static com.kevin.git.data.local.DatabaseContract.FavColumns.TYPEUSER;
import static com.kevin.git.data.local.DatabaseContract.FavColumns.USERNAME;
