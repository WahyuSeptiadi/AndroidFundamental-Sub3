...
import com.kevin.git.view.DetailActivity;
...
import static com.kevin.git.localDatabase.contract.DatabaseContract.FavColumns.AVATAR;
import static com.kevin.git.localDatabase.contract.DatabaseContract.FavColumns.CONTENT_URI;
import static com.kevin.git.localDatabase.contract.DatabaseContract.FavColumns.IDUSER;
import static com.kevin.git.localDatabase.contract.DatabaseContract.FavColumns.TYPEUSER;
import static com.kevin.git.localDatabase.contract.DatabaseContract.FavColumns.USERNAME;
...
//    => Penamaan class sebaiknya diperjelas
    ...
    public DetailSearchListAdapter(Activity activity1) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_detsea_list, parent, false);
