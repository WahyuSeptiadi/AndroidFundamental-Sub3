package com.kevin.git.provider;
...
import com.kevin.git.localDatabase.helper.FavoriteHelper;

import java.util.Objects;

import static com.kevin.git.localDatabase.contract.DatabaseContract.AUTHORITY;
import static com.kevin.git.localDatabase.contract.DatabaseContract.FavColumns.CONTENT_URI;
import static com.kevin.git.localDatabase.contract.DatabaseContract.TABLE_NAME;
...
public class MyContentProvider extends ContentProvider {
    ...
    static {
        // content://com.wahyu.githubapi/favorite BUAT NAMBAH DATA
        sUriMatcher.addURI(AUTHORITY, TABLE_NAME, FAV);
        // content://com.wahyu.githubapi/favorite/id BUAT HAPUS DATA byId (FAV_ID)
    ...
    public Cursor query(@NonNull Uri uri, String[] projection, String selection,
        ...
        switch (sUriMatcher.match(uri)){
            // content://com.wahyu.githubapi/favorite
            case FAV :
                cursor = favoriteHelper.queryAll();
                break;
            // content://com.wahyu.githubapi/favorite/id ---> cuma diambil id nya
            case FAV_ID :
