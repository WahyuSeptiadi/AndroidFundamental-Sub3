package com.kevin.provider.helper.widget;
...
public class ImageFavoriteWidget extends AppWidgetProvider {
    private static final String TOAST_ACTION = "com.kevin.provider.TOAST_ACTION";
    public static final String EXTRA_ITEM = "com.kevin.provider.EXTRA_ITEM";
