package com.kevin.provider.helper.provider;
...
import com.kevin.provider.data.local.FavoriteHelper;

import java.util.Objects;

import static com.kevin.provider.data.local.DatabaseContract.AUTHORITY;
